...
Model regresji logistycznej to uogólniony model liniowy, który możemy stosować gdy zmienna zależna ma charakter dychotomiczny. Regresja logistyczna pozwala na obliczenie prawdopodobieństwa sukcesu, jednak jest ono wyrażone poprzez logarytm ilorazu szans (stosunek prawdopodobieństwa sukcesu do prawdopodobieństwa porażki).
