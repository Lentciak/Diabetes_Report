...
**GenHlth** - zmienna jakościowa-porządkowa, odpowiadająca na pytanie o ogólny (subiektywny) stan zdrowia pacjenta, przyjmuje wartości całkowite od 5 (słaby) do 1 (doskonały)
...
**Age** - zmienna jakościowa-porządkowa określająca wiek pacjenta, przyjmuje wartości:
...
Ostatnim krokiem jest wykonanie predykcji na zbiorze testowym i sprawdzenie skuteczności modelu.
...
Skorzystamy najpierw z algorytmu automatycznej selekcji predyktorów, pozwoli to na wybór odpowiedniego podzbioru zmiennych niezależnych celem uniknięcia niedouczenia lub przeuczenia modelu.
